...
# Create the 'lucas' role in the PostgreSQL server with necessary permissions
docker exec -it my-postgres-db psql -U postgres -c "CREATE ROLE lucas WITH LOGIN PASSWORD 'admin123'; ALTER USER lucas CREATEDB;"
